...
class Trending_list extends StatefulWidget {
  const Trending_list({
    super.key,
  });

  @override
  State<Trending_list> createState() => _Trending_listState();
}

class _Trending_listState extends State<Trending_list> {
  late List Book = [];
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: Book.length.remainder(3),
      itemBuilder: (_, index) {
        return InkWell(
          onTap: () {
            Navigator.push(
